...
import { computeTaskTimeMeta, formatDuration } from "../store/selectors";
      ...
      <div className={`p-3 ${bg}`}>
        ...
        {!compact && (
          <div className="mt-1 text-sm text-gray-700 flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            {showAssignee && task.assignedTo != null && <span>• Assignee: #{task.assignedTo}</span>}
            {showProject && task.projectId != null && <span>• Project: #{task.projectId}</span>}
          </div>
        )}
